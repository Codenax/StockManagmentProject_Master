    ...
    public partial class StockOutUI : Form
    {
        ...
        private void sellButton_Click(object sender, EventArgs e)
        {
           for (int i = 0; i < ProductListDataGridView.Rows.Count; i++)
            ...
            MessageBox.Show("Sales Informetion Save Successfully");            
        }        
        private void damageButton_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Damage Informetion Save Successfully");
            itemStockOutComboBox.Text = "";
            clearReoderQuantityAvilable();
        }
        private void lostButton_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Lost Informetion Save Successfully");
            itemStockOutComboBox.Text = "";
            clearReoderQuantityAvilable();
        }
    }
